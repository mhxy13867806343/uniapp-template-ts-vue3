...
export const neoExtraMoreCatalog: MoreComponentSpec[] = [
  ...
  { name: 'NeoWalletCard', title: '钱包卡片', path: 'neo-wallet-card', kind: 'metric', summary: '适合余额概览、账户资产和钱包状态展示。', scenes: ['余额概览', '账户资产', '钱包状态'], metrics: [{ label: '可用余额', value: '¥8,420' }, { label: '冻结金额', value: '¥640' }, { label: '待结算', value: '¥1,920' }, { label: '免费提现', value: '2 次' }], tone: 'success' },
  { name: 'NeoPaymentMethodPanel', title: '支付方式面板', path: 'neo-payment-method-panel', kind: 'action', summary: '适合支付方式选择、收银台入口和渠道切换。', scenes: ['支付方式选择', '收银台入口', '渠道切换'], subtitle: '支持按业务场景快速切换支付渠道，并突出默认推荐方式。', actions: ['微信支付', '支付宝', '银行卡'], tone: 'brand' },
  { name: 'NeoSubscriptionStatus', title: '订阅状态', path: 'neo-subscription-status', kind: 'info', summary: '适合订阅续费、服务有效期和套餐状态提醒。', scenes: ['订阅续费', '服务有效期', '套餐状态'], subtitle: '当前专业版服务将在 9 天后到期，建议提前完成续费避免能力受限。', meta: '即将到期', actionText: '立即续费', tone: 'warning' },
  { name: 'NeoGiftCardPanel', title: '礼卡面板', path: 'neo-gift-card-panel', kind: 'chip', summary: '适合礼卡领取、兑换入口和节日营销专区。', scenes: ['礼卡领取', '兑换入口', '节日营销'], items: ['生日礼卡', '新人礼卡', '积分兑换', '节日赠礼'], tone: 'warning' },
  { name: 'NeoAffiliateBoard', title: '分销面板', path: 'neo-affiliate-board', kind: 'metric', summary: '适合分销转化、推广返佣和渠道伙伴经营。', scenes: ['分销转化', '推广返佣', '渠道伙伴'], metrics: [{ label: '分销订单', value: '426' }, { label: '活跃伙伴', value: '62' }, { label: '佣金支出', value: '¥18.6k' }, { label: '成交占比', value: '23%' }], tone: 'brand' },
  { name: 'NeoConversionSnapshot', title: '转化快照', path: 'neo-conversion-snapshot', kind: 'metric', summary: '适合广告转化、页面转化和活动转化效果速览。', scenes: ['广告转化', '页面转化', '活动转化'], metrics: [{ label: '点击率', value: '7.8%' }, { label: '加购率', value: '12.4%' }, { label: '支付率', value: '4.1%' }, { label: 'ROI', value: '1.86' }], tone: 'success' },
  { name: 'NeoStorefrontPanel', title: '店铺门面板', path: 'neo-storefront-panel', kind: 'info', summary: '适合店铺首页摘要、门店信息和主视觉简介。', scenes: ['店铺首页摘要', '门店信息', '主视觉简介'], subtitle: '门店整体评分稳定，推荐在晚高峰前更新招牌活动和新品曝光位。', actionText: '进入店铺', tone: 'brand' },
  { name: 'NeoMerchantPulse', title: '商家脉搏', path: 'neo-merchant-pulse', kind: 'profile', summary: '适合商家联系人、店长信息和运营顾问入口。', scenes: ['商家联系人', '店长信息', '运营顾问'], personName: '店长陈宇', personSubtitle: '门店经营稳定 · 今日已处理 36 笔订单', members: ['门店运营', '仓配协同', '客服在线'], tone: 'success' },
  { name: 'NeoCouponStack', title: '券包堆栈', path: 'neo-coupon-stack', kind: 'list', summary: '适合用户券包、券状态聚合和营销资源展示。', scenes: ['用户券包', '券状态聚合', '营销资源'], items: ['满 299 减 40', '运费立减券', '直播专属券', '会员续费券'], tone: 'warning' },
  { name: 'NeoFlashSaleCard', title: '秒杀卡片', path: 'neo-flash-sale-card', kind: 'info', summary: '适合限时秒杀、抢购活动和短时促销入口。', scenes: ['限时秒杀', '抢购活动', '短时促销'], subtitle: '本场秒杀将在 18:00 开启，建议提前预热重点单品并补足库存。', meta: '倒计时', actionText: '查看会场', tone: 'warning' },
  { name: 'NeoReviewSummary', title: '评价摘要', path: 'neo-review-summary', kind: 'metric', summary: '适合评论汇总、满意度分析和口碑概览。', scenes: ['评论汇总', '满意度分析', '口碑概览'], metrics: [{ label: '综合评分', value: '4.8' }, { label: '新增评价', value: '286' }, { label: '带图评价', value: '41%' }, { label: '差评率', value: '1.2%' }], tone: 'success' },
  { name: 'NeoReturnCenter', title: '退货中心', path: 'neo-return-center', kind: 'action', summary: '适合退货申请、逆向物流和售后操作入口。', scenes: ['退货申请', '逆向物流', '售后操作'], subtitle: '退货单已进入仓库签收阶段，可继续跟进退款与商品质检流程。', actions: ['查看退单', '联系仓库', '催办退款'], tone: 'warning' },
  { name: 'NeoAfterSaleBoard', title: '售后看板', path: 'neo-after-sale-board', kind: 'metric', summary: '适合售后效率、问题闭环和服务质量概览。', scenes: ['售后效率', '问题闭环', '服务质量'], metrics: [{ label: '待处理', value: '19' }, { label: '处理中', value: '34' }, { label: '已完成', value: '168' }, { label: '满意度', value: '96%' }], tone: 'brand' },
  { name: 'NeoGeoFenceCard', title: '围栏卡片', path: 'neo-geo-fence-card', kind: 'info', summary: '适合地理围栏、到店提醒和区域告警展示。', scenes: ['地理围栏', '到店提醒', '区域告警'], subtitle: '当前已配置 6 个经营范围围栏，重点门店进入提醒工作正常。', meta: 'LBS', actionText: '查看范围', tone: 'slate' },
  { name: 'NeoPickupPanel', title: '自提面板', path: 'neo-pickup-panel', kind: 'action', summary: '适合门店自提、核销取货和到店服务入口。', scenes: ['门店自提', '核销取货', '到店服务'], subtitle: '今日共有 28 单待自提，建议优先处理临近超时订单。', actions: ['生成取货码', '查看核销', '通知用户'], tone: 'success' },
  { name: 'NeoLiveRoomCard', title: '直播间卡片', path: 'neo-live-room-card', kind: 'info', summary: '适合直播运营、预告入口和直播间状态展示。', scenes: ['直播运营', '预告入口', '直播间状态'], subtitle: '今晚 20:00 将开启新品专场直播，预约人数已达 4.2k。', meta: '直播预告', actionText: '进入直播', tone: 'brand' },
  { name: 'NeoCreatorRank', title: '达人排行', path: 'neo-creator-rank', kind: 'list', summary: '适合达人带货、内容作者和合作伙伴排名展示。', scenes: ['达人带货', '内容作者', '合作伙伴排行'], items: ['第 1 名 小鱼说好物', '第 2 名 阿泽测评', '第 3 名 橙子买手团'], tone: 'brand' },
  { name: 'NeoReferralCard', title: '推荐官卡片', path: 'neo-referral-card', kind: 'profile', summary: '适合推荐计划、邀请裂变和推广人信息展示。', scenes: ['推荐计划', '邀请裂变', '推广人信息'], personName: '推荐官安宁', personSubtitle: '本月已邀请 18 位新用户，转化效率位居前列', members: ['邀请奖励', '分享海报', '推广记录'], tone: 'warning' },
  { name: 'NeoProfitBridge', title: '利润桥卡', path: 'neo-profit-bridge', kind: 'metric', summary: '适合利润分析、成本拆解和毛利结构展示。', scenes: ['利润分析', '成本拆解', '毛利结构'], metrics: [{ label: '销售收入', value: '¥428k' }, { label: '履约成本', value: '¥163k' }, { label: '营销费用', value: '¥42k' }, { label: '毛利率', value: '26%' }], tone: 'success' },
  { name: 'NeoCashflowCard', title: '现金流卡片', path: 'neo-cashflow-card', kind: 'metric', summary: '适合现金流预测、出入账监控和资金安全概览。', scenes: ['现金流预测', '出入账监控', '资金安全'], metrics: [{ label: '流入', value: '¥96k' }, { label: '流出', value: '¥74k' }, { label: '净流入', value: '¥22k' }, { label: '安全阈值', value: '良好' }], tone: 'slate' },
  { name: 'NeoSupplierPanel', title: '供应商面板', path: 'neo-supplier-panel', kind: 'profile', summary: '适合供应商档案、合作状态和联系人展示。', scenes: ['供应商档案', '合作状态', '联系人展示'], personName: '星河供应链', personSubtitle: '合作 3 年 · 履约及时率 98.6%', members: ['主联系人', '对账资料', '交付能力'], tone: 'slate' },
  { name: 'NeoProcurementBoard', title: '采购看板', path: 'neo-procurement-board', kind: 'list', summary: '适合采购待办、请购跟进和供应排期提醒。', scenes: ['采购待办', '请购跟进', '供应排期'], items: ['新物料待询价', '框架合同待续签', '重点品类待补货'], tone: 'brand' },
  { name: 'NeoQualityGate', title: '质检关卡', path: 'neo-quality-gate', kind: 'metric', summary: '适合质量抽检、合格率追踪和批次放行展示。', scenes: ['质量抽检', '合格率追踪', '批次放行'], metrics: [{ label: '抽检批次', value: '48' }, { label: '合格率', value: '97.9%' }, { label: '待复检', value: '3' }, { label: '异常批次', value: '1' }], tone: 'success' },
  { name: 'NeoCompliancePanel', title: '合规面板', path: 'neo-compliance-panel', kind: 'list', summary: '适合合规提醒、制度检查和流程留痕展示。', scenes: ['合规提醒', '制度检查', '流程留痕'], items: ['隐私条款待更新', '供应商资质将到期', '合同模板需复核'], tone: 'warning' },
  { name: 'NeoAccessPass', title: '通行证卡片', path: 'neo-access-pass', kind: 'info', summary: '适合权限通行、访客放行和身份校验入口。', scenes: ['权限通行', '访客放行', '身份校验'], subtitle: '当前访客码有效期剩余 2 小时，可用于前台登记和现场放行。', meta: '已授权', actionText: '查看二维码', tone: 'success' },
  { name: 'NeoSecurityDigest', title: '安全摘要', path: 'neo-security-digest', kind: 'metric', summary: '适合安全巡检、风控统计和账户防护概览。', scenes: ['安全巡检', '风控统计', '账户防护'], metrics: [{ label: '高危事件', value: '0' }, { label: '风险登录', value: '2' }, { label: '设备校验', value: '98%' }, { label: '告警关闭率', value: '93%' }], tone: 'warning' },
  { name: 'NeoMonitorGrid', title: '监控网格', path: 'neo-monitor-grid', kind: 'metric', summary: '适合服务监控、接口健康和运行态指标分布。', scenes: ['服务监控', '接口健康', '运行态指标'], metrics: [{ label: '可用率', value: '99.97%' }, { label: 'P95 延时', value: '182ms' }, { label: '错误率', value: '0.08%' }, { label: '告警中', value: '1' }], tone: 'brand' },
  { name: 'NeoIncidentCard', title: '事件卡片', path: 'neo-incident-card', kind: 'info', summary: '适合故障事件、异常说明和恢复状态展示。', scenes: ['故障事件', '异常说明', '恢复状态'], subtitle: '昨晚支付链路抖动已恢复，当前正观察后续波动并跟进复盘。', meta: '已恢复', actionText: '查看复盘', tone: 'warning' },
  { name: 'NeoEscalationPanel', title: '升级面板', path: 'neo-escalation-panel', kind: 'action', summary: '适合问题升级、专家协同和跨组处理入口。', scenes: ['问题升级', '专家协同', '跨组处理'], subtitle: '如当前问题超出处理 SLA，可直接升级到专家组并同步相关负责人。', actions: ['升级处理', '通知负责人', '生成群聊'], tone: 'slate' },
  { name: 'NeoOpsChecklist', title: '运维清单', path: 'neo-ops-checklist', kind: 'list', summary: '适合上线巡检、值守流程和运维任务确认。', scenes: ['上线巡检', '值守流程', '运维任务确认'], items: ['校验核心监控项', '确认回滚方案', '检查备份状态', '同步值班联系人'], tone: 'slate' }
]
