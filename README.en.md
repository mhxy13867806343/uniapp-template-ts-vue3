...
- Added switchable dynamic form, music player, playlist list and folder tree examples; the dynamic form supports pickers, radios, textarea notes and editable detail rows
